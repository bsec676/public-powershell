...
Get-MsolUser -All | foreach{ 
 ...
 { 
  ...
  $PrintedUser++ 
  $Result=@{'DisplayName'=$DisplayName;'UserPrincipalName'=$upn;'Type'=$Type;'MFAStatus'=$MFAStatus;'ActivationStatus'=$ActivationStatus;'DefaultMFAMethod'=$DefaultMFAMethod;'AllMFAMethods'=$Methods;'MFAPhone'=$MFAPhone;'MFAEmail'=$MFAEmail;'LicenseStatus'=$_.IsLicensed;'IsAdmin'=$IsAdmin; 'SignInStatus'=$SigninStatus}  
  $Results= New-Object PSObject -Property $Result  
  $Results | Select-Object DisplayName,UserPrincipalName,Type,MFAStatus,ActivationStatus,DefaultMFAMethod,AllMFAMethods,MFAPhone,MFAEmail,LicenseStatus,IsAdmin,SignInStatus | Export-Csv -Path $ExportCSVReport -Notype -Append 
 } 
 ...
 { 
  ...
  $Results= New-Object PSObject -Property $Result  
  $Results | Select-Object DisplayName,UserPrincipalName,Department,MFAStatus,LicenseStatus,IsAdmin,SignInStatus,UserType | Export-Csv -Path $ExportCSV -Notype -Append 
 } 
} 
